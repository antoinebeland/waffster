  ...
  ***************************************************************************** */
  ...
  var GridLayout = (function (_super) {
      ...
      function GridLayout(budget, svgElement, config, minCountPerLine) {
          ...
          _this._budgetWidth = factor * (2 * _this._config.horizontalPadding + _this._countPerLine *
      ...
      GridLayout.prototype.initializeLayout = function () {
          ...
          if (this._gaugeGroup) {
              this._gaugeGroup.attr('transform', "translate(" + (this._width / 2 - this._config.gaugeConfig.width / 2) + "," +
          ...
          var initializeLabel = function (d, i, nodes) {
              ...
              var labelLines = textGroup.select('.element-name')
                  .attr('text-anchor', 'middle')
                  .attr('y', _this._config.amountTextHeightY)
                  .selectAll('tspan')
                  .data(lines);
              labelLines.exit()
                  .remove();
